#!/bin/bash
docker-compose up -d --remove-orphans --build --scale lab1_openmpi=8
...
for host_name in `docker network inspect openmpi_main | grep -Po '(?<="Name": \")(openmpi-lab1_openmpi-[_a-z0-9]*)'`
do
